...
function PromptInput({
  ...
  return (
    ...
    >
      {/* 外层 div 仅作为点击扩展区，真正的键盘交互和 focus 语义都落在内层 textarea —— a11y 鼓励 label 方案，
          但 PromptInput 是 compound component，嵌套 label 会吞掉 PromptInputAction 的 Tooltip 事件，故此处显式豁免。 */}
...
function PromptInputTextarea({
  ...
  return (
    <Textarea
      ...
      className={cn(
        "text-foreground min-h-11 w-full resize-none border-none bg-transparent px-2 shadow-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0",
        className
      )}
      rows={1}
      disabled={disabled}
